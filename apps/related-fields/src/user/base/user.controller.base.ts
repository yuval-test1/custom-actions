...
export class UserControllerBase {
  ...
  async findManyAuthors(
    ...
    const results = await this.service.findAuthors(params.id, {
      ...query,
      select: {
        id: true,
        createdAt: true,
  ...
  @common.Post("/:id/authors")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async connectAuthors(
    @common.Param() params: UserWhereUniqueInput,
  ...
  @common.Delete("/:id/authors")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async disconnectAuthors(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: AuthorWhereUniqueInput[]
  ): Promise<void> {
    const data = {
